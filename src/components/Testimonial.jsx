...
function Testimonial() {
  return (
    <div className="flex flex-col rounded-xl items-center w-64 min-w-64 bg-gradient-to-b p-4 mx-4 from-white  font-serif  to-[#db9887]">
      <div class="flex flex-col">
        ...
        <div class=" justify-end items-end flex text-blue-500 text-4xl">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
      ...
      <div className="flex flex-col items-center font-serif w-full justify-center">
        <img
